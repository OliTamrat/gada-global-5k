        ...
        <div className="max-w-5xl mx-auto">
          ...
          <ScrollReveal>
            <div className="text-center mt-10">
              <a href="mailto:info@gadaglobalus.com" className="inline-flex items-center gap-3 yellow-card px-10 py-4 rounded-xl font-bold text-[14px] tracking-wider uppercase hover:-translate-y-0.5 hover:shadow-[0_8px_28px_rgba(245,200,66,0.3)] transition-all no-underline">
                Sponsorship Inquiry
