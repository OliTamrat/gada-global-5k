...
const C = {
  field: "#141210",
  fieldSoft: "#1e1b18",
  // A third field so no two adjacent panels share a colour and the folds stay
  // legible. Deep green is the race's own; it carries body text at 12:1 but
  // not the red display type, which is why the cover stays charcoal.
  forest: "#123018",
  green: "#1B5E20",
  red: "#C62828",
  yellow: "#F5C842",
...
const ANTON = dataUri(resolve(HERE, "fonts/anton-latin.woff2"), "font/woff2");
...
const frontCover = `
  <section class="panel field cover">
...
const theMorning = `
  <section class="panel field morning">
...
const css = `
@font-face { font-family: "Anton"; src: url("${ANTON}") format("woff2"); font-weight: 400; font-display: block; }
...
.field  { background: ${C.field}; color: ${C.cream}; }
.forest { background: ${C.forest}; color: ${C.cream}; }
.cream  { background: ${C.cream}; color: ${C.ink}; }

/* ---- front cover ---- */
.cover-frame {
  position: absolute; inset: 0.17in; border: 1px solid rgba(250,246,238,.22); z-index: 1;
}
...
.powered span {
  display: block; font-size: 6.5pt; letter-spacing: .22em; text-transform: uppercase; color: ${C.gold};
}
.powered strong { display: block; font-size: 8pt; color: ${C.cream}; font-weight: 700; }
...
.display {
  font-family: "Anton", "DM Sans", sans-serif; font-weight: 400;
  text-transform: uppercase; line-height: .86; letter-spacing: -.005em;
}
.d1 { font-size: 46pt; color: ${C.red}; }
.d2 { font-size: 46pt; color: ${C.yellow}; }
.cover-rule { width: 1.5in; height: 3px; background: ${C.gold}; margin: 15px 0 12px; }
.cover-meta { font-size: 8pt; line-height: 1.7; color: rgba(250,246,238,.8); }
.cover-event {
  color: ${C.yellow}; font-weight: 700; letter-spacing: .12em;
...
.kicker {
  ...
  font-size: 25pt; line-height: .92; margin: 0; color: ${C.yellow};
}
...
.facts dt {
  font-size: 6.4pt; letter-spacing: .2em; text-transform: uppercase; color: ${C.gold}; font-weight: 700;
}
...
.disc {
  ...
  display: grid; place-items: center; background: ${C.red}; color: ${C.cream};
...
.sec-title {
  font-family: "Anton", sans-serif; font-weight: 400; text-transform: uppercase;
  font-size: 25pt; line-height: .92; margin: 0; color: ${C.red};
}
...
.sub {
  ...
  color: ${C.goldDim}; font-weight: 700;
}
...
.stat-n {
  font-family: "Anton", sans-serif; font-size: 15pt; line-height: 1; color: ${C.ink};
}
...
.aud-node {
  ...
  background: ${C.field}; color: ${C.cream}; font-size: 7.4pt; font-weight: 700;
}
...
.levels col.spec { width: 42%; }
.levels th, .levels td { padding: 6px 2px; }
...
.lvl {
  ...
  font-size: 8.5pt; color: ${C.ink}; line-height: 1;
}
.amt { display: block; font-size: 7pt; font-weight: 700; color: ${C.red}; margin-top: 3px; }
.levels tbody th {
  text-align: left; font-size: 7pt; font-weight: 400; line-height: 1.35; color: ${C.inkSoft};
  border-bottom: 1px solid ${C.rule}; padding-right: 6px;
}
...
.tier-blurb-head span:last-child { font-size: 7.4pt; font-weight: 700; color: ${C.goldDim}; }
...
.back-title {
  font-family: "Anton", sans-serif; font-weight: 400; text-transform: uppercase;
  font-size: 27pt; line-height: .92; margin: 16px 0 0; color: ${C.ink};
}
